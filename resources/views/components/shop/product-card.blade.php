<a href="{{ route('products.show', $product->slug) }}" class="position-relative">
    ...
    <span class="badge bg-primary position-absolute" style="bottom: -90px; left: 5px;">Bebas Biaya Admin</span>
    <span class="badge bg-danger position-absolute" style="bottom: -90px; left: 125px;">COD</span>
</a>
<div class="p-1">
