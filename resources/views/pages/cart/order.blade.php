...
<div class="container">
    <form action="{{ route('cart.checkout.submit') }}" method="POST" class="">
        @csrf
    <div class="row g-5 mb-4">
        ...
        <div class="col-md-5 col-lg-4 order-md-last">
                ...
                @foreach($cart as $item)
                    <li class="list-group-item d-flex justify-content-between lh-sm">
                        <div>
                            ...
                            <small class="text-body-secondary">{{ $item['name_variation'] }}, Rp {{ number_format($item['price'], 0, ',', '.') }}</small>
                        </div>
            ...
            <div class="my-2">
                ...
                <a href="{{route('cart.checkout.cancel')}}" class="btn btn-secondary">Batal</a>
            </div>
        </div>
    </div>
    </form>
